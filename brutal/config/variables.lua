...
RED = ColourNameToRGB (RGBColourToName(GetNormalColour(2)))
GREEN = ColourNameToRGB (RGBColourToName(GetNormalColour(3)))
YELLOW = ColourNameToRGB (RGBColourToName(GetNormalColour(4)))
BLUE = ColourNameToRGB (RGBColourToName(GetNormalColour(5)))
MAGENTA = ColourNameToRGB (RGBColourToName(GetNormalColour(6)))
CYAN = ColourNameToRGB (RGBColourToName(GetNormalColour(7)))
WHITE = ColourNameToRGB (RGBColourToName(GetNormalColour(8)))
BRIGHTBLACK = ColourNameToRGB (RGBColourToName(GetBoldColour(1)))
BRIGHTRED = ColourNameToRGB (RGBColourToName(GetBoldColour(2)))
BRIGHTGREEN = ColourNameToRGB (RGBColourToName(GetBoldColour(3)))
BRIGHTYELLOW = ColourNameToRGB (RGBColourToName(GetBoldColour(4)))
BRIGHTBLUE = ColourNameToRGB (RGBColourToName(GetBoldColour(5)))
BRIGHTMAGENTA = ColourNameToRGB (RGBColourToName(GetBoldColour(7)))
